...
function getInput(event) {
  ...
  let context = `Accordingly to your knowledge, generate a beautiful poem with two stanzas and a single title in this format: <h2 class="poem-title">title</h2><p class="poem-text">poem verse </br> poem verse</br> poem verse</br> poem verse</p>`;
